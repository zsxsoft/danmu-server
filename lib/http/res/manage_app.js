var manage = (function() {
	...
	manageControllers.controller("ConfigCtrl",
		function($scope, $http) {
			...
			$scope.config.realConfig.openstate = true;

			$scope.config.text = {};
			$scope.config.text.openstate = "开";

			$scope.config.setState = function() {
				$scope.config.realConfig.openstate = !$scope.config.realConfig.openstate;
				$scope.config.text.openstate = ($scope.config.realConfig.openstate ? "开" : "关");
			}
